        ...
        <div class="container" >
            <div class="row">
                ...
                <div class="col-12 overflow-scroll" style="height: 550px;">
                    ...
                    <form action="{{ route('medicalTest.add') }}" method="POST">
                        @csrf
                        <div class="row mb-3">
                            <label style="font-size: 12px;"for="test_name" class="col-sm-2 col-form-label">Medical Test
                                <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input  style=" font-size: 12px;" type="text" class="form-control" id="test_name" name="test_name" required>
                            </div>
                        </div>
