                        ...
                        <form action="{{ route('patientupdate', $patient->id) }}" class="row g-3 needs-validation"
                            ...
                            <div class="col-md-2">
                                ...
                                <input style=" font-size: 12px;" type="text"
                                    ...
                                    placeholder="National Identity Card No" value="{{ $patient->nic }}" >
                            </div>
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-sm-10">
                                        <label style="font-size: 12px;">Feets</label> <input style=" font-size: 12px; width: 50px;"
                                            ...
                                            value="{{ $patient->height_feets }}" step="0.1" min="0"
                                            max="100">
                                        <label style="font-size: 12px;">Inches</label><input style=" font-size: 12px; width: 50px;"
                                            ...
                                            value="{{ $patient->height_inches }}" step="0.1" min="0"
                                            max="100">
                                        <label style="font-size: 12px;">Centimeters</label> <input
                                            ...
                                            value="{{ $patient->height_cen }}" step="0.1" min="0"
                                            max="500">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row mb-1">
                                    <div class="col-sm-10">
                                        <input style=" font-size: 12px;" type="text" class="form-control"
                                            ...
                                            placeholder="Job Profession" value="{{ $patient->occupation }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
