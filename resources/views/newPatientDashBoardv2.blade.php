        ...
        <div class="col-12" >
            <div class="container-fluid ml-4" style="background-color:#FFFFFF; border-radius:10px;">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-4">
                        <i class="fa fa-user-o" style="font-size:16px;"></i>patient <b>{{ $p->name }}</b>
                    ...
                    <div class="container-fluid py-1" style="background-color: #b2d8e5; border-radius:10px;">
                        <div class="row  h-auto" >
                            ...
                            <div class="col-md-3 col-sm-6 px-1">
                                <div class="row mx-1 my-1" style="height:98%;">
                                    <div class="container-fluid" style="background-color: #EBEFF3; border-radius:10px;">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col text-center">
                                                <textarea id="investigation_details" style="line-height: 1.4;font-size: 13px; background-color: #EBEFF3;height:25dvh;width:100%;" name="investigation_details" placeholder="Investigation Details" value="">
                            ...
                            <div class="col-md-3 col-sm-6 px-1" >
                                <!--Treatments-->
                                <div class="row my-1 mx-0" style="height:48%">
                                ...
                                <div class="row  my-1 mx-0" style="height:50%">
                                    <!--Medical Test-->
