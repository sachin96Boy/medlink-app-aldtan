                    ...
                    <div class="container-xxl">
                        <div class="row">
                            ...
                            <div class="col-3">
                                ...
                                <b><span id="myDiv"></span></b> <i class="fa fa-bell-o"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="flex-container-extend" style="margin-top: 10px;">
                                                    <div class="p-0"
                                                        ...
                                                        <div class="dropdown" style="margin-top:10px;">
                                                            <select class="form-control select2" id="investigation"
                                                                            ...
                                                                            <option value="" selected style="size:10px;"></option>
                                                           ...
                                                           <textarea  id="investigation_details" style="background-color: #EBEFF3; margin-top: 40px;height: 300px; width: 270px;" name="investigation_details" placeholder="Investigation Details" value="{{ $inv->investigation_details }}"></textarea>
                                                    ...
                                                    <div>
                                                        <div class="p-2  align-self-start"
                                                            ...
                                                            <textarea id="treatment" name="treatment" rows="5" cols="23"
                                                                style="background-color: #EBEFF3; margin-top:10px; height:279px; width:210px;border-style: none;border: 0px solid #EBEFF3;">{{ $inv->treatment }}</textarea>
                                                        </div>
                                                        <div class="p-2"
                                                    ...
                                                    <div>
                                                        <div class="p-2  align-self-start"
                                                            ...
                                                            <div class="p-0">
                                                                ...
                                                                <div class="table-responsive "
                                                                    style="font-size:12px; width: 490px;  height:280px;">
                                                                    <div class="row">
                                                                ...
                                                                DRUGS :</b>
                                                                        ...
                                                                        name="opd_drugs" rows="4" style="width: 300px;">
                                                                        <option value="" selected style="size:10px;"></option>
                                                        ...
                                                        <div class="p-2 align-self-end"
                                                            ...
                                                            <div class="p-0 ">
                                                                ...
                                                                <div class="table-responsive "
                                                                    style="font-size:12px;  width: 490px;  height:170px;">
                                                                        ...
                                                                        name="outside_drugs" rows="4" style="width: 300px;">
                                                                        <option value="" selected style="size:10px;"></option>
                                                    ...
                                                    <div class="p-2" >
                                                        ...
                                                        <div class="p-2"
                                                            style="height:290px;  width: 150px; background-color: #EBEFF3; border: none;">Remark
                                                            <textarea value="{{ $inv->comment }}" id="comment" name="comment" rows="10" cols="3"
                                                                style="height:265px;  width: 140px; background-color: #EBEFF3; border: none;margin-top:1.5px;"></textarea>
                                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="flex-container-extend" style="margin-top: 10px;">
                                                    <div class="p-0"
                                                        ...
                                                        <div class="dropdown" style="margin-top:10px;">
                                                            ...
                                                            <table id="investigationTable" style="width: 100%;">
                                                             ...
                                                             <textarea id="investigation_details" style="background-color: #EBEFF3; margin-top: 40px;height: 300px; width: 270px;" name="investigation_details" placeholder="Investigation Details"></textarea>
                                                    </div>
                                                    </div>

                                                    <div>
                                                        <div class="p-2  align-self-start"
                                                            style="margin-top: 10px; width: 220px; height:310px; border: 0px solid  #EBEFF3; background-color: #EBEFF3;">
                                                            <b>TREATMENTS</b>
                                                            <textarea id="treatment" name="treatment" rows="5" cols="23"
                                                                style="background-color: #EBEFF3; margin-top:10px; height:279px; width: 209px;border: 2px solid  #EBEFF3;  "></textarea>
                                                        </div>
                                                        <div class="p-2"
                                                            style="height:198px; width: 220px; border:0px solid white; background-color: #EBEFF3; ">
                                                            <b>MEDICAL TESTS</b>
                                                            <div id="medicalDropdown" class="dropdown-content"
                                                            style="margin-top: 10px;">
                                                            <select class="form-control select2" id="medicalTest"
                                                            ...
                                                            <div class="p-0 ">
                                                                ...
                                                                <div class="table-responsive "
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <select class="select2" id="outside_drugs" name="outside_drugs" rows="4" style="width: 300px;">
                                                                                <option value="" selected style="size:10px;"></option>
                                                                                @foreach ($drugs as $drug)
                                                                                <option value="{{ $drug->drug_name }}"
                                                                                    style="size:10px;">
                                                    ...
                                                    <div class="p-2" style="margin-left: 2px;">
                                                        ...
                                                        <div class="p-2"
                                                            style="height:290px;  width: 150px; background-color: #EBEFF3; border: none; ">Remark
                                                            <textarea id="comment" name="comment" value="-" rows="10" cols="3"
                                                                style="height:265px;  width: 140px; background-color: #EBEFF3; border: none; margin-top:2px;"></textarea>
                                                        </div>

                                                        <label for="tname"
                                                            style="text-align:left ; color:white; background-color:#dbb8b3; height:60px; width: 148px;  margin-top: 20px;">
                                                            <br><label>Total Amount</label>
                                                            <input step="100"  value="" id="amount" name="amount"
                                                                type="number" class="form-control"
                                                                style="text-align:left ; background-color:#e3b8b1; border:none;"></label>
    ...
    <script>
        $(document).ready(function () {
            ...
            function addRowToTableopd(drugName) {
                ...
                var newRow = '<tr>' +
                    '<td style="text-align: left; line-height: 1.3;" ><input type="hidden" style="font-size:10px;" name="opdid[]" class="form-control" value="' + drugName + '">' + drugName + '</td>'+
                    '<td><input type="text" style="font-size:10px;" name="opddose[]" class="form-control"></td>' +
                    '<td><input type="text" style="font-size:10px;" name="opdperiod[]" class="form-control"></td>' +
                    '<td><button type="button" style="font-size:10px;" class="btn-sm btn-danger delete-row">Delete</button></td>' +
                    '</tr>';
                table.append(newRow);
            ...
            function addlist(drugName) {
                ...
                var table = $('#listView');
                var newItem = '<tr>' +
                            '<input type="hidden" style="font-size:10px;" name="medid[]" class="form-control" value="'+drugName+'"> '+drugName +
     ...
     var newItem = '<tr>' +
     '<input type="hidden" style="font-size:10px;" name="invid[]" class="form-control" value="'+drugName+'"> '+drugName +
         '<td style="text-align: left; line-height: 1.3;">' + drugName + '</td>' +
